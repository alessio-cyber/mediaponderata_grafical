...
window.title("media_ponderata_v0.1")
window.resizable(False, False)
window.configure(background="#1a1a1a", border=50)

FILE_NAME = "mediaponderata_graphical_utenti.txt"
dizionario = {}
...
tk.Label(window, textvariable=lista, justify="left" ,font=('calibre',10,'bold'), bg='#1a1a1a', fg='white').grid(row=8, column=0, columnspan=2 ,padx=(10,10), pady=(5,5)); show()
